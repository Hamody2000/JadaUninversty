...
{
    $html = ('<a class="LogoBox" href="' . url('/') . '"> <img src="' . showImage(setting('light_logo'), 'logo.png') . '" alt="img"></a>');
    echo $html;
}
function darkLogo($light = true)
{
    $html = ('<a class="LogoBox" href="' . url('/') . '"> <img src="' . showImage(setting('light_logo'), 'logo_w.png') . '" alt="img"></a>');
    echo $html;
}
