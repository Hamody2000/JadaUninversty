...
class CMSSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                'title' => 'General Description', // 1
                'snake_title' => 'general_description',
                'order' => 9,
                'type' => 'api',
            ],
        ...
        $routes1 = [
            [
                'name' => 'Organization',
                'link' => route('frontend.organization.create'),
                'status_id' => 1,
            ],
            [
        ...
        $routes2 = [
            ...
            [
                'name' => ___('frontend.Events'),
                'link' => route('event.home.event.list'),
                'status_id' => 1,
            ],
        ];
