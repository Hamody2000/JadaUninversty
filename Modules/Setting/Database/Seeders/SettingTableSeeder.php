    ...
    public function run()
    {
        try {
            Setting::create([
                ...
                'value' => 'Jeddah University incubator',
            ]);
            Setting::create([
            ...
            Setting::create([
                'name' => 'footer_text',
                'value' => '© ' . date('Y') . ' Black Hourse . All rights reserved.',
            ]);
            Setting::create([
                'name' => 'file_system',
                'value' => 'local',
            ...
            Setting::create([
                ...
                'value' => 'Jeddah University incubator - Learning Management System web application. web-based responsive application that includes an online learning management system, as well as admin, instructor panel and student panel. This is a completely ready-to-use learning management system.',
            ]);
