...
{{--            <div class="card-body">--}}
{{--                <form action="{{ route('startups.update', $data['startup']->id) }}" enctype="multipart/form-data" method="post" id="visitForm">--}}
{{--                    @csrf--}}
{{--                    @method('PUT')--}}
{{--                    <div class="row mb-3">--}}
{{--                        <div class="col-lg-12">--}}
...
{{--                                    <label for="exampleDataList" class="form-label ">{{ ___('startups.Startup Title') }} <span--}}
{{--                                            class="fillable">*</span></label>--}}
{{--                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"--}}
{{--                                           list="datalistOptions" id="exampleDataList"--}}
{{--                                           value="{{ @$data['startup']->getTranslation('title', 'en') ?? old('title') }}"--}}
...
{{--                                <div class="col-xl-6 col-md-6 mb-3">--}}
{{--                                    <label for="exampleDataList" class="form-label ">{{ ___('startups.Startup Arabic Title') }} <span--}}
{{--                                            class="fillable">*</span></label>--}}
{{--                                    <input class="form-control ot-input @error('title_ar') is-invalid @enderror" name="title_ar"--}}
{{--                                           list="datalistOptions" id="exampleDataList"--}}
{{--                                           value="{{ @$data['startup']->getTranslation('title', 'ar') ?? old('title_ar') }}"--}}
...
{{--                                <div class="col-xl-6 col-md-6 mb-3">--}}
{{--                                    <label for="exampleInputEmail1" class="form-label">{{ ___('startups.Description') }} <span--}}
{{--                                            class="fillable">*</span></label>--}}
{{--                                    <input type="text" name="description"--}}
{{--                                           value="{{ @$data['startup']->getTranslation('description', 'en') ?? old('description') }}"--}}
...
{{--                                <div class="col-xl-6 col-md-6 mb-3">--}}
{{--                                    <label for="exampleInput" class="form-label">{{ ___('startups.Arabic Description') }} <span--}}
{{--                                            class="fillable">*</span></label>--}}
{{--                                    <input type="text" name="description_ar"--}}
{{--                                           value="{{ @$data['startup']->getTranslation('description', 'ar') ?? old('description_ar') }}"--}}
...
{{--                                    </label>--}}
{{--                                    <div--}}
{{--                                        @if(@$data['startup']->image)--}}
{{--                                            data-val="{{ showImage($data['startup']->image->original) }}"--}}
{{--                                        @endif--}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('title_ar') is-invalid @enderror" name="title_ar"
                                                           ...
                                                           value="{{ @$data['startup']->getTranslation('title', 'ar') ?? old('title') }}"
                                                           placeholder="{{ ___('startups.Enter Startup Title In Arabic') }}">
                                                    @error('title_ar')
                                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                                        {{ $message }}
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        placeholder="{{ ___('startups.Enter Startup Description') }}"
                                                    >{{ @$data['startup']->getTranslation('description', 'en') ?? old('description') }}</textarea>
                                                    @error('description')
                                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        placeholder="{{ ___('startups.Enter Startup Description In Arabic') }}"
                                                    >{{ @$data['startup']->getTranslation('description', 'ar') ?? old('description') }}</textarea>
                                                    @error('description_ar')
                                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('industry') is-invalid @enderror" name="industry"
                                                           list="datalistOptions" id="industry"
                                                           value="{{ @$data['startup']->getTranslation('industry', 'en') ?? old('industry') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('industry_ar') is-invalid @enderror" name="industry_ar"
                                                           list="datalistOptions" id="industry_ar"
                                                           value="{{ @$data['startup']->getTranslation('industry', 'ar') ?? old('industry') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('mission') is-invalid @enderror" name="mission"
                                                           list="datalistOptions" id="mission"
                                                           value="{{ @$data['startup']->getTranslation('mission', 'en') ?? old('mission') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('mission_ar') is-invalid @enderror" name="mission_ar"
                                                           ...
                                                           value="{{ @$data['startup']->getTranslation('mission', 'ar') ?? old('mission') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('vision') is-invalid @enderror" name="vision"
                                                           list="datalistOptions" id="vision"
                                                           value="{{ @$data['startup']->getTranslation('vision', 'en') ?? old('vision') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('vision_ar') is-invalid @enderror" name="vision_ar"
                                                           ...
                                                           value="{{ @$data['startup']->getTranslation('vision', 'ar') ?? old('vision') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('email') is-invalid @enderror" name="email"
                                                           list="datalistOptions" id="email" value="{{ @$data['startup']->email ?? old('email') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control ot-input @error('contact_num') is-invalid @enderror" name="contact_num"
                                                           list="datalistOptions" id="contact_num" value="{{ @$data['startup']->contact_num ?? old('contact_num') }}"
                                                ...
                                                <div class="col-xl-12 col-md-12 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('website') is-invalid @enderror" name="website"
                                                           list="datalistOptions" id="exampleDataList" value="{{ @$data['startup']->website ?? old('website') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_name') is-invalid @enderror" name="founder_name"
                                                           list="datalistOptions" id="founder_name"
                                                           value="{{ @$data['startup']->getTranslation('founder_name', 'en') ?? old('founder_name') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_name_ar') is-invalid @enderror" name="founder_name_ar"
                                                           list="datalistOptions" id="founder_name_ar"
                                                           value="{{ @$data['startup']->getTranslation('founder_name', 'ar') ?? old('founder_name') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_role') is-invalid @enderror" name="founder_role"
                                                           list="datalistOptions" id="founder_role"
                                                           value="{{ @$data['startup']->getTranslation('founder_role', 'en') ?? old('founder_role') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_role_ar') is-invalid @enderror" name="founder_role_ar"
                                                           list="datalistOptions" id="founder_role_ar"
                                                           value="{{ @$data['startup']->getTranslation('founder_role', 'ar') ?? old('founder_role') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_email') is-invalid @enderror" name="founder_email"
                                                           list="datalistOptions" id="founder_email" value="{{ @$data['startup']->founder_email ?? old('founder_email') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('founder_linkedin_url') is-invalid @enderror" name="founder_linkedin_url"
                                                           list="datalistOptions" id="founder_linkedin_url" value="{{ @$data['startup']->founder_linkedin_url ?? old('founder_linkedin_url') }}"
                                                ...
                                                <div class="col-xl-12 col-md-6 mb-3">
                                                    ...
                                                    <div
                                                         @if(@$data['startup']->founder_image)
                                                             data-val="{{ showImage($data['startup']->founder_image->original) }}"
                                                         @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_name') is-invalid @enderror" name="co_founder_name"
                                                           list="datalistOptions" id="co_founder_name"
                                                           value="{{ @$data['startup']->getTranslation('co_founder_name', 'en') ?? old('co_founder_name') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_name_ar') is-invalid @enderror" name="co_founder_name_ar"
                                                           list="datalistOptions" id="co_founder_name_ar"
                                                           value="{{ @$data['startup']->getTranslation('co_founder_name', 'ar') ?? old('co_founder_name') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_role') is-invalid @enderror" name="co_founder_role"
                                                           list="datalistOptions" id="co_founder_role"
                                                           value="{{ @$data['startup']->getTranslation('co_founder_role', 'en') ?? old('co_founder_role') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_role_ar') is-invalid @enderror" name="co_founder_role_ar"
                                                           list="datalistOptions" id="co_founder_role_ar"
                                                           value="{{ @$data['startup']->getTranslation('co_founder_role', 'ar') ?? old('co_founder_role') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_email') is-invalid @enderror" name="co_founder_email"
                                                           list="datalistOptions" id="co_founder_email" value="{{ @$data['startup']->co_founder_email ?? old('co_founder_email') }}"
                                                ...
                                                <div class="col-xl-6 col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control ot-input @error('co_founder_linkedin_url') is-invalid @enderror" name="co_founder_linkedin_url"
                                                           list="datalistOptions" id="co_founder_linkedin_url" value="{{ @$data['startup']->co_founder_linkedin_url ?? old('co_founder_linkedin_url') }}"
                                                ...
                                                <div class="col-xl-12 col-md-6 mb-3">
                                                    ...
                                                    <div
                                                         @if(@$data['startup']->co_founder_image)
                                                             data-val="{{ showImage($data['startup']->co_founder_image->original) }}"
                                                         @endif
