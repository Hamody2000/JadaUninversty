        ...
        <div class="table-content table-basic ecommerce-components product-list">
            <div class="card">
                <div class="card-body">
                    ...
                    <div
                        ...
                        @if (hasPermission('page_create'))
                            <div class="align-self-center d-flex gap-2">
                                <!-- add btn -->
                                <div class="align-self-center">
                                    <a href="{{ route('startups.create') }}" role="button" class="btn-add"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody class="tbody">
                                ...
                                @forelse ($data['startups'] as $key => $startup)
                                    <tr>
                                        <td>{{ @$startup->id }}</td>
                                                    ...
                                                    @if (hasPermission('slider_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('startups.edit', $startup->id) }}"><span
                                                                    class="icon mr-12"><i
                                                    ...
                                                    @if (hasPermission('page_delete'))
                                                        <li>
                                                            <a class="dropdown-item delete_data" href="javascript:void(0);"
                                                                data-href="{{ route('startups.destroy', $startup->id) }}">
                    ...
                    <!--  table end -->
                    <!--  pagination start -->
                    @include('backend.ui-components.pagination', ['data' => $data['startups']])
                    <!--  pagination end -->
                </div>
            </div>
        </div>
