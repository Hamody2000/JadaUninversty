    ...
    <section class="ot-checkout-area section-padding bottom-padding">
        <div class="container">
            <form action="{{ route('frontend.event.checkout.payment') }}" method="post">
                @csrf
                <div class="row gutter-x-55 d-flex justify-content-center">
                    {{--<div class="col-lg-7">
                                            ...
                                            <div class="payment-gateway-list d-flex  justify-content-between align-items-center">
                                                <div class="single-gateway-item">
                                                    <div class="payment-icon">
                                                        {{ @$data['course'] }}
                                                        <img src="{{ showImage(@$payment_method->image->original, 'payments/' . @$payment_method->name . '.png') }}"
                                                            alt="{{ @$payment_method->name }}" class="cover-image w-2">
                                                    </div>
