        ...
        <div class="table-content table-basic ecommerce-components product-list">
            <div class="card">
                <div class="card-body">
                    ...
                    <div
                        ...
                        @if (hasPermission('page_create'))
                            <div class="align-self-center d-flex gap-2">
                                <!-- add btn -->
                                <div class="align-self-center">
                                    <a href="{{ route('services.create') }}" role="button" class="btn-add"
                            ...
                            <tbody class="tbody">
                                ...
                                @forelse ($data['services'] as $key => $service)
                                    <tr>
                                        ...
                                        <td>
                                            <img width="100" src="{{ showImage(@$service->image->original, 'default-1.jpeg') }}" alt="service image">
                                        </td>

                                        <td class="create-date">{{ showDate(@$service->created_at) }}</td>
                                                    ...
                                                    @if (hasPermission('slider_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('services.edit', $service->id) }}"><span
                                                                    class="icon mr-12"><i
                    ...
                    <!--  table end -->
                    <!--  pagination start -->
                    @include('backend.ui-components.pagination', ['data' => $data['services']])
                    <!--  pagination end -->
                </div>
            </div>
        </div>
