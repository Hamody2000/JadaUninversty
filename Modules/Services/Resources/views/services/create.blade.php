...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('services.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        list="datalistOptions" id="exampleDataList" value="{{ old('title') }}"
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title_ar') is-invalid @enderror" name="title_ar"
                                        list="datalistOptions" id="exampleDataList" value="{{ old('title_ar') }}"
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    <label for="exampleInput" class="form-label">{{ ___('services.Arabic Description') }} <span
                                            class="fillable">*</span></label>
                                    <input type="text" name="description_ar" value="{{ old('description_ar') }}"
