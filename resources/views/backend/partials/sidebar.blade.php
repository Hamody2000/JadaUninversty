        ...
        <div class="sidebar-logo">
            <a href="{{ route('dashboard') }}">
                <img id="sidebar_full_logo" class="full-logo setting-image"
                    src="{{ @showImage(setting('light_logo'), 'logo_w.png') }}" alt="img" />
    ...
    <div class="sidebar-menu sidebar_scrollbar_active" id="sidebar_scroll">
        ...
        <div class="sidebar-menu-section">
            ...
            <ul class="sidebar-dropdown-menu parent-menu-list">
                        ...
                        <ul class="child-menu-list">
                            ...
                            @if (module('Event') && hasPermission('report_event_booking'))
                                <li class="sidebar-menu-item {{ set_menu(['report.event-booking']) }}">
                                    <a href="{{ route('report.event-booking') }}">{{ ___('report.Event Booking') }}</a>
                                </li>
                            @endif
                ...
                {{-- start Subscription  --}}
                @if(module('Subscription') && (hasPermission('package_read') || hasPermission('package_duration_type_read') || hasPermission('package_purchase_read') ))
                    @include('subscription::panel.admin.partials.sidebar')
                @endif
                {{-- end Subscription  --}}

                 <!-- event Layout Start -->
                 @if (module('Event') && (hasPermission('requested_event_list') || hasPermission('approved_event_list') || hasPermission('rejected_event_list') || hasPermission('event_category_read') || hasPermission('purchase_booking')))
                ...
                @if (hasPermission('general_settings_read'))
                    ...
                    <li class="sidebar-menu-item">
                        <a class="parent-item-content has-arrow">
                            ...
                            <span class="on-half-expanded">{{ ___('backend_sidebar.Startups') }}</span>
                        </a>

                        <!-- second layer child menu list start  -->
                        <ul class="child-menu-list">
                            @if (hasPermission('general_settings_read'))
                                <li class="sidebar-menu-item {{ set_menu(['admin/startups*', 'admin/live-class/*']) }}">
                                    <a href="{{ route('startups.index') }}">{{ ___('backend_sidebar.Startups List') }}</a>
                                </li>
                            @endif
                ...
                @if (hasPermission('general_settings_read'))
                    ...
                    <li class="sidebar-menu-item">
                        <a class="parent-item-content has-arrow">
                            ...
                            <span class="on-half-expanded">{{ ___('backend_sidebar.Services') }}</span>
                        </a>

                        <!-- second layer child menu list start  -->
                        <ul class="child-menu-list">
                            @if (hasPermission('general_settings_read'))
                                <li class="sidebar-menu-item {{ set_menu(['admin/services*', 'admin/live-class/*']) }}">
                                    <a href="{{ route('services.index') }}">{{ ___('services.Services List') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
