        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="BU_Ai_Fin_Indiv_Item HavBoxShadow">
                    <div class="image">
                        <img src="https://uj-incubator.uj.edu.sa/frontend/assets/NewImages/redAsset_9.svg">
                    </div>
                    <div class="tem_Dtata">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="BU_Ai_Fin_Indiv_Item ">
                    <div class="image">
                        <img src="https://uj-incubator.uj.edu.sa/frontend/assets/NewImages/redAsset_20.svg">
                    </div>
                    <div class="tem_Dtata">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="BU_Ai_Fin_Indiv_Item ">
                    <div class="image">
                        <img src="https://uj-incubator.uj.edu.sa/frontend/assets/NewImages/redAsset_27.svg">
                    </div>
                    <div class="tem_Dtata">
                        <h1>{{ ___('frontend.Financial Investment') }}</h1>
                        <p>{{ ___('frontend.We provide investment with our VC Look AI Ventures fund.') }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
