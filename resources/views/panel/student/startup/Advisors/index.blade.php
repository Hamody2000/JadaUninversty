...
@section('content')
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content data">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('startups.advisors.add', @$data['startup_id']) }}" method="post" id="modal_values" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3 d-flex justify-content-center">
                                    <div class="col-xl-12 mb-3">


                                        <!-- Start Ar, En inputs for Startup Advisor Name -->
                                        <div class="col-12 mb-3">
                                            <label for="name" class="form-label ">{{ ___('startups.Startup Advisor Name') }} <span
                                                    class="fillable">*</span></label>
                                            <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                                    list="datalistOptions" id="name" value="{{ old('name') }}"
                                                    placeholder="{{ ___('startups.Enter Startup Advisor Name') }}">
                                            @error('name')
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="name_ar" class="form-label ">{{ ___('startups.Startup Arabic Advisor Name') }} <span
                                                    class="fillable">*</span></label>
                                            <input class="form-control ot-input @error('name_ar') is-invalid @enderror" name="name_ar"
                                                    ...
                                                    placeholder="{{ ___('startups.Enter Startup Advisor Name In Arabic') }}">
                                            @error('name_ar')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <!-- End Ar, En inputs for Startup Advisor Name -->

                                        <!-- Start Ar, En inputs for Startup Advisor Role -->
                                        <div class="col-12 mb-3">
                                            <label for="role" class="form-label ">{{ ___('startups.Startup Advisor Role') }} <span
                                                    class="fillable">*</span></label>
                                            <input class="form-control ot-input @error('role') is-invalid @enderror" name="role"
                                                    list="datalistOptions" id="role" value="{{ old('role') }}"
                                                    placeholder="{{ ___('startups.Enter Startup Advisor Role') }}">
                                            @error('role')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="role_ar" class="form-label ">{{ ___('startups.Startup Arabic Advisor Role') }} <span
                                                    class="fillable">*</span></label>
                                            <input class="form-control ot-input @error('role_ar') is-invalid @enderror" name="role_ar"
                                                    ...
                                                    placeholder="{{ ___('startups.Enter Startup Advisor Role In Arabic') }}">
                                            @error('role_ar')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <!-- End Ar, En inputs for Startup Advisor Role -->

                                        <!-- Start Ar, En inputs for Startup Advisor Description -->
                                        <div class="col-12 mb-3">
                                            <label for="description" class="form-label">{{ ___('startups.Advisor Description') }} <span
                                                    class="fillable">*</span></label>
                                            <textarea
                                                name="description"
                                                id="description"
                                                class="form-control ot-textarea  @error('description') is-invalid @enderror"
                                                placeholder="{{ ___('startups.Enter Startup Advisor Description') }}"
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="description_ar" class="form-label">{{ ___('startups.Arabic Advisor Description') }} <span
                                                    class="fillable">*</span></label>
                                            <textarea
                                                name="description_ar"
                                                id="description_ar"
                                                class="form-control ot-textarea  @error('description_ar') is-invalid @enderror"
                                                placeholder="{{ ___('startups.Enter Startup Advisor Description In Arabic') }}"
                                        ...
                                        <!-- End Ar, En inputs for Startup Advisor Description -->
                ...
                <div class="mb-24">
                    <div class="activity-table">
                        <table class="table-responsive">
                            ...
                            <tbody>
                                @forelse (@$data['advisors'] as $member)
                                    <tr>
                                        <td>{{ @$member->id }}</td>
                                            ...
                                            <div class="modal fade lead-modal" id="staticBackdrop-{{ $member->id }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('startups.advisor.delete', [@$data['startup_id'], $member->id]) }}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="row mb-3 d-flex justify-content-center">
                                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                                        <h3 class="text-warning">
                                                                        {{ ___('startups.Are you sure to delete this Advisor?') }}
                                                                        </h3>
                                                                    </div>
                                                                </div>
    ...
    <!--  pagination start -->
    {!! @$data['advisors']->links('frontend.partials.pagination-count') !!}
    <!--  pagination end -->
