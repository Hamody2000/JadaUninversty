...
@section('content')
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content data">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('startups.impacts.add', @$data['startup_id']) }}" method="post" id="modal_values" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="mb-24">
                    <div class="activity-table">
                        <table class="table-responsive">
                            ...
                            <tbody>
                                @forelse (@$data['impacts'] as $impact)
                                    <tr>
                                        <td>{{ @$impact->id }}</td>
                                        <td>
                                            ...
                                            <div class="modal fade lead-modal" id="staticBackdrop-{{ $impact->id }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('startups.impacts.delete', [@$data['startup_id'], $impact->id]) }}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="row mb-3 d-flex justify-content-center">
                                                                    <div class="col-xl-12 col-md-6 mb-3">
    ...
    <!--  pagination start -->
    {!! @$data['impacts']->links('frontend.partials.pagination-count') !!}
    <!--  pagination end -->
