...
let featuredCoursesUrl = webUrl + "/" + apiEndpoint + "/featured-courses"; 
let latestCoursesUrl = webUrl + "/" + apiEndpoint + "/latest-courses"; 
let bestRatedCoursesUrl = webUrl + "/" + apiEndpoint + "/best-rated-courses"; 
let mostPopularCoursesUrl = webUrl + "/" + apiEndpoint + "/most-popular-courses";
let discountCoursesUrl = webUrl + "/" + apiEndpoint + "/discount-courses"; 


let popularCategoryUrl = webUrl + "/" + apiEndpoint + "/popular-category"; 
let becomeAnInstructorUrl = webUrl + "/" + apiEndpoint + "/become-an-instructor"; 
let educationalEventsUrl = webUrl + "/" + apiEndpoint + "/educational-events"; 
let blogsUrl = webUrl + "/" + apiEndpoint + "/blogs"; 
let testimonialUrl = webUrl + "/" + apiEndpoint + "/testimonials"; 
let brandsUrl = webUrl + "/" + apiEndpoint + "/brands";
let homeSliderUrl               = webUrl + "/" + apiEndpoint + "/home-sliders";
let menuCategoriesUrl               = webUrl + "/" + apiEndpoint + "/menu-categories";
let packagesUrl = webUrl + "/" + apiEndpoint + "/subscription-packages";
